...
- GitHub Copilot에서 호출 가능: `@CEO /feature`, `@QA /test` 같은 명령어 사용
...
- 각 스킬은 `.skill.md` 파일로 정의되고, 특정 문제 해결 방식을 인코딩
...
- [GitHub Copilot Agent 문서](https://docs.github.com/en/copilot/building-copilot-extensions/building-a-custom-copilot)
